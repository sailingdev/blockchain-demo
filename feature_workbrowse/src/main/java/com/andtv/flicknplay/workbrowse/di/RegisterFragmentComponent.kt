...
import com.andtv.flicknplay.workbrowse.di.module.RegisterApiModule
...
interface RegisterFragmentComponent {
    ...
    interface Factory {
        fun create(@BindsInstance view: RegisterPresenter.View): RegisterFragmentComponent
    }
