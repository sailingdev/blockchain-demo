...
import com.andtv.flicknplay.workbrowse.presentation.model.Source
import io.reactivex.Single
import org.junit.Test

/**
 * Copyright (C) Flicknplay 2019-08-26.
 */
...
class GetWorkByGenreUseCaseTest {
    ...
    fun `should return the right data when loading a movie page`() {
        whenever(getMovieByGenreUseCase(MOVIE_GENRE.name, 1))
    ...
    fun `should return the right data when loading a tv show page`() {
        whenever(getTvShowByGenreUseCase(TV_SHOW_GENRE.name, 1))
