...
import com.andtv.flicknplay.workbrowse.domain.model.GenreDomainModel
import io.reactivex.Single
import org.junit.Test

/**
 * Copyright (C) Flicknplay 28-05-2019.
 */
...
class GetWorkBrowseDetailsUseCaseTest {
    ...
    private val continueWatchingMoviesUseCase: ContinueWatchingMoviesUseCase = mock()
    private val useCase = GetWorkBrowseDetailsUseCase(
            hasFavoriteUseCase,
            getMovieGenresUseCase,
            getTvShowGenresUseCase,
            continueWatchingMoviesUseCase
    )
