...
public class CustomMediaPlayerGlue extends PlaybackControlGlue implements
     ...
     * Constructor.
     */
    public CustomMediaPlayerGlue(Context context) {
    ...
    protected void onAttachedToHost(PlaybackGlueHost host) {
        ...
        if (host instanceof SurfaceHolderGlueHost) {
            ((SurfaceHolderGlueHost) host).setSurfaceHolderCallback(
                    new CustomMediaPlayerGlue.VideoPlayerSurfaceHolderCallback());
        }
    }
        ...
        if (mInitialized) {
            ...
            if (callbacks != null) {
                for (PlayerCallback callback: callbacks) {
                    callback.onPreparedStateChanged(CustomMediaPlayerGlue.this);
                }
            }
        }
    }
    ...
    public void play(int speed) {
        ...
        mPlayer.start();
        mPlayer.seekTo(mPlayer.getDuration() / 4);
